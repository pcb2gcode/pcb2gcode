...
\version    1.1.5 - 2013 - Erik Schuster - erik@muenchen-ist-toll.de\n
            ...
            - Added metricoutput option to ExcellonProcessor call.
            - Different code for unit calculation.
            - Started documenting the code for doxygen processing.

\version    1.1.4 - 2009, 2010, 2011 Patrick Birnzain <pbirnzain@users.sourceforge.net> and others
...
int main (int argc, char* argv[])
{
        ...
        if (vm.count ("drill")) {
                ...
                try {
                        ExcellonProcessor ep (vm["drill"].as<string>(), board->get_min_x() + board->get_max_x(), vm["metricoutput"].as<bool>());

...
options::options()
   ...
   cfg_options.add_options()
       ...
       ("drills-available", po::value<string>(), "List of available drills separated width ','. Tolerance can be specified with added '':<-tol>:<+tol>''")
       ("drills-tolerance", po::value<double>()->default_value(0.1), "Acceptable tolerance from available drills (default 0.1mm)" )

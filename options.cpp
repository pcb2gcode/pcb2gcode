...
options::options()
   ...
   optimization_options.add_options()
       ...
       ("min-path-length", po::value<Length>()->default_value(parse_unit<Length>("0.1mm")), "Skip milling paths shorter than this length.  Useful for removing tiny Voronoi artifacts.  Set to 0.1mm to remove paths shorter than 0.1mm.");

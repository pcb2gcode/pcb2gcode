...
const char *autoleveller::probeCode[] = { "G38.2", "G31", "G31", "G31" };
const char *autoleveller::zProbeResultVar[] = { "#5063", "#2002", "#2002", "#2002" };
 ...
 */
/******************************************************************************/
autoleveller::autoleveller( double XProbeDist, double YProbeDist, double zwork, Software software, double zprobe,
 ...
 zwork( str( format("%.5f") % zwork ) ),
 zprobe( str( format("%.3f") % zprobe ) ),
 zsafe( str( format("%.3f") % zsafe ) ),
 zfail( str( format("%.3f") % zfail ) ),
 feedrate( boost::lexical_cast<string>( feedrate ) ),
 probeOn( boost::replace_all_copy(probeOn, "@", "\n") ),
 probeOff( boost::replace_all_copy(probeOff, "@", "\n") ),
 software( software )
{
